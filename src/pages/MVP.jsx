...
function MVP(props) {
  const SUPABASE_URL = "https://abdulkcysybmhiqbcmsl.supabase.co";
  ...
  //     .from("scoutF20")
  //     .select("short_name, club, value_eur")
  //     .gt("value_eur", 90000000);
  //   console.log(data);
  // }

  return (
    <div className="god">
      <form className="angel">
        <label htmlFor="fname" className="field">Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <input
          type="text"
          id="fname"
          name="fname"
        ...
        <br />
        {/* /////////////////////////////// */}
        <label htmlFor="Africa">Nationality&nbsp;&nbsp;&nbsp;</label>
        <select
          id="Africa"
          name="Africa"
        >
        ...
        <button type="submit">Search Playahs</button>
      </form>
    </div>
  );
}
